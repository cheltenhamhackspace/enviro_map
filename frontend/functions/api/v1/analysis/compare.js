...
export async function onRequest(context) {
    ...
    try {
        ...
        if (sensorIds.length < 2) {
            return apiError('invalid_request', 'At least 2 sensors required for comparison', 400);
        }
        ...
        return apiError('internal_error', 'Failed to generate comparative analysis', 500);
    }
}
